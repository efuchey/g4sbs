...
void G4SBSEArmBuilder::BuildComponent(G4LogicalVolume *worldlog){
  ...
  //------------ BigBite: -----------------------------------------------------
  if( exptype == G4SBS::kGMN || exptype == G4SBS::kGEN || exptype == G4SBS::kSIDISExp || exptype == G4SBS::kA1n  || exptype == G4SBS::kGEnRP || exptype == G4SBS::kGEp_BB || exptype == G4SBS::kALL || exptype == G4SBS::kPhiExp) 
    {
